      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-background to-muted py-20 md:py-32">
        ...
        <div className="container relative mx-auto px-4 text-center">
          ...
          <p className="mx-auto mb-8 max-w-2xl text-pretty text-lg text-muted-foreground md:text-xl">
            Authentic Japanese Pokémon cards · Fixed prices · Exact card shown
          </p>
          <Link href="/products">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-sm text-muted-foreground">
                All our cards are sourced directly from Japan and guaranteed authentic with fixed pricing.
              </p>
            </div>
            <div className="flex flex-col items-center text-center">
